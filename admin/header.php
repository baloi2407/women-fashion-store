...
<head>
  ...
  <title>Admin Shop quan ao</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <!-- danh muc -->
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#danhmuc" aria-expanded="false" aria-controls="danhmuc">
          ...
          <!-- san pham -->
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#sanpham" aria-expanded="false" aria-controls="sanpham">
              <i class="icon-layout menu-icon"></i>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="taikhoan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="index.php?act=addtk">Thêm tài khoản</a></li>
                <li class="nav-item"> <a class="nav-link" href="index.php?act=listtk">Danh sách tài khoản</a></li>
              </ul>
            </div>
          </li>
          <!-- end tai khoan -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="bill">
              <ul class="nav flex-column sub-menu">
                <!-- <li class="nav-item"> <a class="nav-link" href="index.php?act=addtk">Thêm tài khoản</a></li> -->
                <li class="nav-item"> <a class="nav-link" href="index.php?act=listbill">Danh sách bill</a></li>
              </ul>
            </div>
          </li>
          <!-- end bill -->
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#thongke" aria-expanded="false" aria-controls="thongke">
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">thongke</span>
              <i class="menu-arrow"></i>
            </a>
